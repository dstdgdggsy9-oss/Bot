...
# ---------------------------^𝐁 ᴇ 𝐀 s 𝐓 ~ 💗...!!?
TOKENS = [
    "8430061289:AAGOJPaQUGh9Dj7eaffHHxZNYpOluBwzEiM",
    "8431605538:AAGkbrIW3OR80vWrPu1qbZpfQG8dg9gmBI4", 
    "8489517186:AAGNq9Cdz73FW6fNmxeMz1nTku09I018bew",
    
    "8530729582:AAFB5v9AnWHz7V8Na9vOM-M1ALienIOz4KM",
    
    "8014130677:AAHjELjVzW-GW7l5hPpxcyQDZjSkxQBV474",
    "8201229517:AAGmG3ObuOfddy4p3VjSKht72Xd_irjpXcY"
]
...
RAID_TEXTS = [
    ...
    "teri माँ मारेगी", "tbkc", "चल तेरी माँ की चुत", "^𝐁 ᴇ 𝐀 s 𝐓 ~ 💗...!!? बाप🗿🌙💯💯"
]
...
def only_sudo(func):
    async def wrapper(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if uid not in SUDO_USERS:
            await update.message.reply_text("❌ 𝐘ᴏᴜʀ 𝐖ᴏʀᴅs 𝐀ʀᴇ 𝐔sᴇʟᴇss 𝐈 𝐎ɴʟʏ 𝐒ᴇʀᴠᴇ 𝐌ᴏɴᴀʀᴄʜ ^𝐁 ᴇ 𝐀 s 𝐓 ~ 💗...!!?")
            return
...
async def gcnc(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🔄 𝐇ᴀᴛᴇʀs 𝐊ɪ 𝐌ᴀᴀ 𝐂ᴏᴅɴᴀ 𝐂ʜᴀʟᴜ ᴋᴀʀ ᴅɪʏᴀ ʜᴀɪ")
...
async def ncemo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    group_tasks[chat_id] = tasks
    await update.message.reply_text("🎭 𝐄ᴍᴏᴊɪ 𝐒ᴇ 𝐇ᴀᴛᴇʀ 𝐊ɪ 𝐂ᴜᴅᴀɪ 𝐒ʜᴜʀᴜ 𝐊ᴀʀ 𝐃ɪ 𝐆ᴀʏɪ 𝐇ᴀɪ")
...
async def stopgcnc(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id in group_tasks:
        ...
        await update.message.reply_text("⏹𝐌ᴏɴᴀʀᴄʜ  ^𝐁 ᴇ 𝐀 s 𝐓 ~ 💗...!!? 𝐍ᴇ 𝐇ᴀᴛᴇʀs 𝐊ɪ 𝐂ᴜᴅᴀɪ 𝐑ᴏᴋ 𝐃𝐢")
    else:
...
async def stopncemo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id in group_tasks:
        for task in group_tasks[chat_id]:
            task.cancel()
        del group_tasks[chat_id]
        await update.message.reply_text("⏹ 𝐄ᴍᴏᴊɪ 𝐒ᴇ 𝐇ᴀᴛᴇʀs ᴋɪ 𝐂ᴜᴅᴀɪ 𝐑ᴏᴋ 𝐃ɪ")
    else:
...
async def targetslide(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"🎯 𝐒ʟɪᴅᴇ 𝐒ᴇ 𝐂ᴜᴅᴀɪ 𝐂ʜᴀʟᴜ: {target_id}")
...
async def stopslide(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"🛑 𝐒ʟɪᴅᴇ 𝐒ᴇ 𝐂ᴜᴅᴀɪ 𝐁ᴀɴᴅ: {target_id}")
